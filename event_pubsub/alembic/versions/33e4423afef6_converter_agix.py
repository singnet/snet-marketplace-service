...
Revision ID: 33e4423afef6
Revises: 17b7b512f5c0
Create Date: 2022-02-09 09:36:56.288224
...
revision = '33e4423afef6'
down_revision = '17b7b512f5c0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('converter_agix_events_raw',
    ...
    sa.UniqueConstraint('transactionHash', 'logIndex', name='uq_converter_agix_ev')
    )
    op.create_index('blk_no_idx', 'converter_agix_events_raw', ['block_no'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('blk_no_idx', table_name='converter_agix_events_raw')
    op.drop_table('converter_agix_events_raw')
    # ### end Alembic commands ###
