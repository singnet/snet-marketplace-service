...
BLOCKCHAIN_EXCLUDE_PATHS = [
    "root._Organization__uuid",
    "root._Organization__duns_no",
    "root._Organization__registration_id",
    "root._Organization__registration_type",
    "root._Organization__origin",
    "root._Organization__state",
...
ORGANIZATION_MINOR_CHANGES = [
    "root._Organization__state",
    "root._Organization__assets['hero_image']['url']",
    "root._Organization__assets['hero_image']['ipfs_hash']",
...
class Organization:
    ...
    def to_metadata(self):
        ...
        for key, asset in self.assets.items():
            ...
            if not hash_uri.startswith(ipfs_uri_prefix) and not hash_uri.startswith(
                filecoin_uri_prefix
            ):
    ...
    def to_response(self):
        ...
        return {
            ...
            "state": self.org_state.to_response()
            if isinstance(self.org_state, OrganizationState)
            else {},
        }
