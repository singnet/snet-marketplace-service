...
class ServicePublisherService:
    ...
    def publish_new_offchain_configs(
        ...
        status = self._prepare_publish_status(
            username, organization, current_service, request.storage_provider, publish_to_blockchain, new_offchain_configs
        )
    ...
    def _prepare_publish_status(
        ...
        status: Dict[str, Any] = {"publish_to_blockchain": publish_to_blockchain}
