...
from registry.application.services.org_transaction_status import org_repo, OrganizationTransactionStatus
from registry.application.services.service_transaction_status import service_repo, ServiceTransactionStatus
from registry.constants import OrganizationMemberStatus, OrganizationStatus, Role, ServiceStatus
from registry.infrastructure.models import Organization, OrganizationMember, Group, OrganizationState, Service, \
    ServiceState, OrganizationAddress
...
class TestTransactionStatus(TestCase):
    ...
    def test_update_org_transaction_status(self, mock_blockchain_utils):
        ...
        org_state = org_repo.session.query(OrganizationState).filter(
            OrganizationState.org_uuid == test_org_uuid).first()
