...
class TestServiceEventConsumer(unittest.TestCase):
    ...
    #         {"encoding": "proto",
    #          "service_type": "grpc",
    #          "model_hash": "QmXqonxB9EvNBe11J8oCYXMQAtPKAb2x8CyFLmQpkvVaLf"},
    ...
    # @patch("from registry.infrastructure.storage_provider.StorageProvider", return_value=Mock(
    #     read_bytesio_from_ipfs=Mock(return_value=""),
    #     get=Mock(return_value=json.loads(json.dumps(service_metadata))),
    #     publish=Mock(return_value="Q3E12")))
    # @patch('common.s3_util.S3Util.push_io_bytes_to_s3')
    # @patch('common.blockchain_util.BlockChainUtil')
