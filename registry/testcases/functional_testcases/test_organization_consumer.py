...
from registry.infrastructure.models import Organization, Service, ServiceGroup, ServiceState, OrganizationState, \
...
class TestOrganizationService(unittest.TestCase):
    ...
    def test_organization_create_event(self, mock_get_org_details_from_blockchain, nock_read_bytesio_from_ipfs,
    ...
    @patch('common.ipfs_util.IPFSUtil.read_bytesio_from_ipfs')
    @patch('registry.consumer.organization_event_consumer.OrganizationEventConsumer._get_org_details_from_blockchain')
    def test_organization_create_event_from_snet_cli(self, mock_get_org_details_from_blockchain, nock_read_bytesio_from_ipfs,
                                       mock_ipfs_read, mock_s3_push,
                                       mock_ipfs_write):
        username = "karl@dummy.com"
        test_org_uuid = uuid4().hex
