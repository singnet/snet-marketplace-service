...
TEST_SUB = "test_sub"
ORG_CONTACTS = [
    {"contact_type": "support", "email_id": "abcd@abcdef.com", "phone": "1234567890"},
    {"contact_type": "org", "email_id": "dummy@abcdef.com", "phone": "1234567890"},
]
...
ORG_PAYLOAD_MODEL = json.dumps(
    {
        ...
        "org_address": {"mail_address_same_hq_address": False, "addresses": []},
...
ORG_RESPONSE_MODEL = json.dumps(
    {
        ...
        "origin": ORIGIN,
        "contacts": [
            {"phone": "1234567890", "email_id": "abcd@abcdef.com", "contact_type": "support"},
            {"phone": "1234567890", "email_id": "dummy@abcdef.com", "contact_type": "org"},
        ],
        "assets": {"hero_image": {"url": "", "ipfs_hash": ""}},
        "metadata_uri": "ipfs://Q12PWP",
