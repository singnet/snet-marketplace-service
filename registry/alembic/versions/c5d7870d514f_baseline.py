...
Revision ID: c5d7870d514f
Revises: 
Create Date: 2020-02-05 02:24:24.112069
...
def upgrade():
    ...
    sa.Column('service_id', sa.VARCHAR(length=128), nullable=True),
    sa.Column('metadata_ipfs_hash', sa.VARCHAR(length=255), nullable=True),
    ...
    sa.Column('git_url', sa.VARCHAR(length=512), nullable=True),
    sa.Column('assets', mysql.JSON(), nullable=False),
    ...
    sa.Column('free_call_signer_address', sa.VARCHAR(length=128), nullable=True),
    sa.Column('created_on', mysql.TIMESTAMP(), nullable=False),
    sa.Column('updated_on', mysql.TIMESTAMP(), nullable=False),
