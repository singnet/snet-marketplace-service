...
from registry.domain.models.service_state import ServiceState as ServiceStateEntityModel
...
class ServicePublisherRepository(BaseRepository):
    ...
    def save_service(self, username: str, service: ServiceEntityModel, state: ServiceStateEntityModel) -> Union[None, ServiceEntityModel]:
