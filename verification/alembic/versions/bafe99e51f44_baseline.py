...
Revision ID: bafe99e51f44
Revises: 
Create Date: 2020-03-02 18:51:33.905430
...
def upgrade():
    ...
    sa.Column('callback_type', mysql.VARCHAR(length=255), nullable=True),
    sa.Column('verification_status', mysql.VARCHAR(length=255), nullable=True),
    sa.Column('id_scan_status', mysql.VARCHAR(length=255), nullable=True),
    sa.Column('id_scan_source', mysql.VARCHAR(length=255), nullable=True),
