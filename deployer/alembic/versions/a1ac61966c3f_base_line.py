...
Revision ID: a1ac61966c3f
Revises: 
Create Date: 2025-08-26 19:49:52.503807
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('INIT', 'READY_TO_START', 'STARTING', 'RESTARTING', 'DELETING', 'UP', 'DOWN', 'ERROR', name='daemonstatus'), nullable=False),
    ...
    op.create_table('transactions_metadata',
    ...
    op.create_table('claiming_period',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('daemon_id', sa.VARCHAR(length=128), nullable=False),
    sa.Column('start_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('end_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'FAILED', name='claimingperiodstatus'), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['daemon_id'], ['daemon.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_claiming_period_daemon_id'), 'claiming_period', ['daemon_id'], unique=False)
    op.create_table('order',
    sa.Column('id', sa.VARCHAR(length=128), nullable=False),
    sa.Column('daemon_id', sa.VARCHAR(length=128), nullable=False),
    sa.Column('status', sa.Enum('PROCESSING', 'SUCCESS', 'FAILED', name='orderstatus'), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['daemon_id'], ['daemon.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    ...
    op.create_table('evm_transaction',
    sa.Column('hash', sa.VARCHAR(length=128), nullable=False),
    sa.Column('order_id', sa.VARCHAR(length=128), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'SUCCESS', 'FAILED', name='evmtransactionstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_evm_transaction_order_id'), 'evm_transaction', ['order_id'], unique=False)
