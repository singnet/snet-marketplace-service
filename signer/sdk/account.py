...
from snet_cli.utils import normalize_private_key, get_address_from_private, get_contract_object

DEFAULT_GAS = 210000


class TransactionError(Exception):
    """Raised when an Ethereum transaction receipt has a status of 0. Can provide a custom message.
    Optionally includes receipt"""
