...
class TestSignUPAPI(unittest.TestCase):
    ...
    def test_signature_for_free_call(self, report_slack_mock):
        signature_for_free_call = {
            ...
            "requestContext": {"authorizer": {"claims": {"email": "dummy@dummy.com"}}},
        }
    ...
    def test_signature_for_state_service(
        self,
        mock_boto_client,
        mock_read_contract_address,
        mock_current_block_no,
        mock_report_slack,
    ):
        ...
        mock_read_contract_address.return_value = (
        ...
        assert (
            response_body["data"]["snet-current-block-number"]
    ...
    def test_signature_for_open_channel_for_third_party(
        ...
        assert (
            ...
            == "0x6057e2706d63351e774eaf56616afa7c138129b27b0dfd121457761d4267c3b8"
        )
        assert (
            response_body["data"]["s"]
            == "0x2f2b98ae088f6e5d4737fae8beba95c7203d33c07baaeccbb8eea5a6c361ae84"
        )
        assert response_body["data"]["v"] == 27
        assert (
            response_body["data"]["signature"]
            == "0x6057e2706d63351e774eaf56616afa7c138129b27b0dfd121457761d4267c3b82f2b98ae088f6e5d4737fae8beba95c7203d33c07baaeccbb8eea5a6c361ae841b"
        )
