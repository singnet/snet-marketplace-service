...
class ChannelStateReply(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"current_signed_amount",
            "old_nonce_signature",
            b"old_nonce_signature",
            "old_nonce_signed_amount",
            b"old_nonce_signed_amount",
            "planned_amount",
            b"planned_amount",
            "used_amount",
            b"used_amount",
...
class GetFreeCallTokenRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_token_lifetime_in_blocks",
            b"_token_lifetime_in_blocks",
            "_user_id",
            b"_user_id",
            "token_lifetime_in_blocks",
            b"token_lifetime_in_blocks",
            "user_id",
            b"user_id",
        ],
    ) -> builtins.bool: ...
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_token_lifetime_in_blocks", b"_token_lifetime_in_blocks"]
    ) -> typing.Literal["token_lifetime_in_blocks"] | None: ...
    @typing.overload
    def WhichOneof(
...
class FreeCallStateRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["_user_id", b"_user_id", "user_id", b"user_id"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class FreeCallStateReply(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["free_calls_available", b"free_calls_available"]
    ) -> None: ...
