...
from wallets.dao.channel_transaction_status_data_access_object import ChannelTransactionStatusDataAccessObject
...
transaction_repo = ChannelTransactionStatusDataAccessObject(connection)
