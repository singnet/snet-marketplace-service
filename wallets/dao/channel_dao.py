...
class ChannelDAO:
    ...
    def get_channel_transactions_for_username_recipient(
        ...
        query = (
            "SELECT W.username, W.address, W.type, W.is_default, CT.recipient, CT.amount, "
    ...
    def get_channel_transactions_against_order_id(self, order_id):
        query = (
            "SELECT order_id, amount, currency, type, address, transaction_hash, status, row_created as created_at "
