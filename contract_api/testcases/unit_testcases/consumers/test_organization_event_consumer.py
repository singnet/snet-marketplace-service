...
class TestOrganizationEventConsumer(unittest.TestCase):
    ...
    # @patch('contract_api.infrastructure.storage_provider.IPFSUtil.read_file_from_ipfs')
    ...
    def test_organziation_create_update_event(self):
        ...
        return_value = "snet", ["snet", "", "",
                                                                     "0xB18aac9DE3852F988147287daBD19dF2791C2e0f"], ipfs_mock_value, "abc"
        with patch('contract_api.consumers.organization_event_consumer.OrganizationEventConsumer._get_org_details_from_blockchain', return_value=return_value):
            with patch('contract_api.consumers.organization_event_consumer.EventConsumer._push_asset_to_s3_using_hash', return_value="http://test-s3-push"):
