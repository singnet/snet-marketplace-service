...
def clean_data(setup_database):
    ...
    with engine.connect() as conn:
        ...
        tables = [row[0] for row in result]
        for table in tables:
            if table not in ['alembic_version', 'alembic_version_contract_api']:
...
def mock_db_session(db_session):
    """Replace the default session in BaseRepository with the test session."""
...
class TestDataFactory:
    ...
    def create_organization_data(
        ...
        **kwargs
        ...
        """Build organization domain data."""
        defaults = {
    ...
    def create_org_group_data(
        ...
        **kwargs
        ...
        """Build organization group domain data."""
        defaults = {
            "payment": {
    ...
    def create_service_metadata_data(
        ...
        **kwargs
        ...
        """Build service metadata domain data."""
        defaults = {
    ...
    def create_service_group_data(
        ...
        **kwargs
        ...
        """Build service group domain data."""
        defaults = {
    ...
    def create_service_endpoint_data(
        ...
        **kwargs
        ...
        """Build service endpoint domain data."""
        defaults = {
    ...
    def create_service_media_data(
        ...
        **kwargs
        ...
        """Build service media domain data."""
        defaults = {
...
def org_repo(db_session):
    """Provides the organization repository."""
...
def base_service(db_session, service_repo, base_organization, test_data_factory):
    """Create a base service with metadata, group, and endpoint."""
    # Create the service
