...
class UserPreferenceAlreadyExistsException(UserRepositoryException):
    ...
    def __init__(self, user_row_id: int, preference_type: str, communication_type: str, source: str):
        super().__init__(f"User preference for user with row ID '{user_row_id}', "
