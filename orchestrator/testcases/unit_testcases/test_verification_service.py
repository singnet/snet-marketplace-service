...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_fields(self, mock_requests):
        ...
        response_obj.__setattr__("_content", json.dumps(mock_response_json).encode("utf-8"))
